...
todaysDateForOneDayTable = date.today().strftime('%y%m%d')
print("crawling for date: ", todaysDateForOneDayTable)
...
for handle in twitterHandles:
    try:
        ...
        for status in statuses:
            ...
            if created_at.timestamp() < start_ts:
                continue
            #sql = "REPLACE INTO twitter_import$stream_v2 (NAME, caller, NO_OF_TWEETS, FOLLOWING, FOLLOWERS, INITIAL_TWEET_BY, MESSAGE, message_id, date_hour, NO_OF_RETWEETS, NO_OF_LIKES, ORIGINAL_OR_RETWEET) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            ...
            sql = "REPLACE INTO tw_" + todaysDateForOneDayTable + "_day (NAME, caller, NO_OF_TWEETS, FOLLOWING, FOLLOWERS, INITIAL_TWEET_BY, message, message_id, date_hour, NO_OF_RETWEETS, NO_OF_LIKES, ORIGINAL_OR_RETWEET) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            val = (name, handle, str(tweets_count), str(friends_count), str(followers_count), author, message, message_id, created_at, str(retweet_count), str(favorite_count), original_or_retweet)
        ...
        print("[TWEEPY ERROR] ", tweepy.TweepError)
        pass
    except:
        print("[TWITTER CRAWL DEBUG] in Twitter Crawl exception")
        pass
